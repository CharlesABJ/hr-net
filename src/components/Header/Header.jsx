  ...
  return (
    <header className="Header">
      <div className="container-zone">
        ...
        <nav className={isHome ? "hidden" : ""}>
          <ul>
            <li>
              <NavLink to="/create-employee">Add New Employee</NavLink>
            </li>
            <li>
              <NavLink to="/view-employees">View Current Employees</NavLink>
            </li>
          </ul>
        </nav>

        <Link title="Logout" to="/" className="logout-button">
          {logoutIcon}
        </Link>
      </div>
    </header>
